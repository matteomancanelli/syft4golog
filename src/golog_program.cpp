...
bool GologProgramNil::equals(const GologProgramNode& x) const {
    return type_id_ == x.get_type_id();
}

void GologProgramNil::accept(GologProgramNodeVisitor& v) {v.visit(*this);}
...
bool GologProgramUnd::equals(const GologProgramNode& x) const {
    return type_id_ == x.get_type_id();
}

void GologProgramUnd::accept(GologProgramNodeVisitor& v) {v.visit(*this);}
...
bool GologProgramAction::equals(const GologProgramNode& x) const {
    return type_id_ == x.get_type_id() && (action_name_ == dynamic_cast<const GologProgramAction&>(x).action_name_);
}

void GologProgramAction::accept(GologProgramNodeVisitor& v) {v.visit(*this);}
...
bool GologProgramTest::equals(const GologProgramNode& x) const {
    return type_id_ == x.get_type_id() && (arg_->equals(*dynamic_cast<const GologProgramTest&>(x).arg_));
}

void GologProgramTest::accept(GologProgramNodeVisitor& v) {v.visit(*this);}
...
bool GologProgramSequence::equals(const GologProgramNode& x) const {
...
void GologProgramSequence::accept(GologProgramNodeVisitor& v) {v.visit(*this);}
...
bool GologProgramChoice::equals(const GologProgramNode& x) const {
    if (type_id_ == x.get_type_id()) {
...
void GologProgramChoice::accept(GologProgramNodeVisitor& v) {v.visit(*this);}
...
bool GologProgramIteration::equals(const GologProgramNode& x) const {
    return type_id_ == x.get_type_id() && 
        (arg_->equals(*dynamic_cast<const GologProgramIteration&>(x).arg_));
}

void GologProgramIteration::accept(GologProgramNodeVisitor& v) {v.visit(*this);}
...
std::string GologProgramNodeToString::apply(GologProgramNode& x) {
    x.accept(*this);
    return result_;
}