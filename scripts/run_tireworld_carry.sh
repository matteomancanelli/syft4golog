...
DOMAIN="$REPO_ROOT/benchmarks/tireworld_carry/domain.pddl"
RESULTS="$REPO_ROOT/results/results_tireworld_carry.csv"
...
for line_dim in $(seq 3 12); do
  PROBLEM="$REPO_ROOT/benchmarks/tireworld_carry/p${line_dim}.pddl"

  for expertise in 1 2 3; do
    GOLOG="$REPO_ROOT/benchmarks/tireworld_carry/prog_${expertise}_${line_dim}.golog"
