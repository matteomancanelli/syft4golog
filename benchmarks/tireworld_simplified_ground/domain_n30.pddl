(define (domain triangle-tire-n30)
  (:requirements :typing :strips :non-deterministic)
  (:types location)
  (:constants l1 l2 l3 l4 l5 l6 l7 l8 l9 l10 l11 l12 l13 l14 l15 l16 l17 l18 l19 l20 l21 l22 l23 l24 l25 l26 l27 l28 l29 l30 - location)
  (:predicates
    (at ?loc - location)
  ...
  (:action move_l22_l21
    :precondition (and (at l22) (not-flattire))
    :effect (and
      (at l21)
      (not (at l22))
      (oneof (and) (not (not-flattire)))
  ...
  (:action move_l23_l22
    :precondition (and (at l23) (not-flattire))
    :effect (and
      (at l22)
      (not (at l23))
      (oneof (and) (not (not-flattire)))
  ...
  (:action move_l24_l23
    :precondition (and (at l24) (not-flattire))
    :effect (and
      (at l23)
      (not (at l24))
      (oneof (and) (not (not-flattire)))
  ...
  (:action move_l25_l24
    :precondition (and (at l25) (not-flattire))
    :effect (and
      (at l24)
      (not (at l25))
      (oneof (and) (not (not-flattire)))
  ...
  (:action move_l26_l25
    :precondition (and (at l26) (not-flattire))
    :effect (and
      (at l25)
      (not (at l26))
      (oneof (and) (not (not-flattire)))
  ...
  (:action move_l27_l26
    :precondition (and (at l27) (not-flattire))
    :effect (and
      (at l26)
      (not (at l27))
      (oneof (and) (not (not-flattire)))
  ...
  (:action move_l28_l27
    :precondition (and (at l28) (not-flattire))
    :effect (and
      (at l27)
      (not (at l28))
      (oneof (and) (not (not-flattire)))
  ...
  (:action move_l29_l28
    :precondition (and (at l29) (not-flattire))
    :effect (and
      (at l28)
      (not (at l29))
      (oneof (and) (not (not-flattire)))
  ...
  (:action move_l30_l29
    :precondition (and (at l30) (not-flattire))
    :effect (and
      (at l29)
      (not (at l30))
      (oneof (and) (not (not-flattire)))
